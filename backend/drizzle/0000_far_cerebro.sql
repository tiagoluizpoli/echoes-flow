...
CREATE TYPE "public"."member_status" AS ENUM('pending', 'active', 'paused', 'ended');--> statement-breakpoint
...
CREATE TABLE "church_address" (
	...
	CONSTRAINT "church_address_church_id_unique" UNIQUE("church_id")
);
...
CREATE TABLE "church" (
	...
	CONSTRAINT "church_payment_gateway_customer_id_unique" UNIQUE("payment_gateway_customer_id")
);
--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	CONSTRAINT "usersTable__email_deletedAt_unique" UNIQUE("email","deleted_at")
);
--> statement-breakpoint
...
CREATE INDEX "churchTable__payment_gateway_customer_id_idx" ON "church" USING btree ("payment_gateway_customer_id");--> statement-breakpoint
