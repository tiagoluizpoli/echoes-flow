import { validateCnpjFormat } from 'src/shared-modules/core/utils';
import { z } from 'zod';
...
export const createChurckHeadersParamsSchema = z.object({
  'x-flow-church-id': z.string(),
});

export type CreateChurchHeadersParams = z.infer<
  typeof createChurckHeadersParamsSchema
>;
